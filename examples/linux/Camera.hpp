...
// Arcball orbit camera for the Linux example — ported from examples/macos/Camera.hpp,
// swapping Apple's <simd/simd.h> types for a small local Vec3 + plain float[16] output.
